...
async function generateAliasDocumentation() {
  ...
  const docContent = `# Sistema de Aliases do md-555-37
...
O md-555-37 utiliza um sistema centralizado de aliases TypeScript para simplificar imports e manter consistência em todo o projeto.
